...
const BootcampSchema = new mongoose.Schema(
  {
    ...
    phone: {
      type: String,
      maxlength: [20, "Phone should be less than 20 characters"]
    },
    ...
    averageRating: {
      ...
      max: [10, "Rating shoud not be more than 10"]
    },
